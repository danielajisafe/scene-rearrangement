...
class MarkovVAEBuilder(object):
    """MarkovVAE Model Builder Class
    """

    def __init__(self):
        """MarkovVAE Model Builder Class Constructor
        """
        self._instance = None
    ...
    def __call__(self, model_cfg, **_ignored):
        ...
        Returns:
            MarkovVAE: Instantiated MarkovVAE network object
        """
        if not self._instance:
            self._instance = MarkovVAE(model_cfg=model_cfg)
